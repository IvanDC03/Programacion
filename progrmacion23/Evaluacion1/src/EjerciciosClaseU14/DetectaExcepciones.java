...
public class DetectaExcepciones {
	...
	public static void main(String[] args) {
		...
		Object a;
		//int longitud = (asteriscos % lineas) == 0 ? asteriscos / lineas : (int)Math.ceil((double)a\ steriscos / lineas);

		 int cuentaAsteriscos = 0; for (int i = 1; i <= lineas; i++) { 
