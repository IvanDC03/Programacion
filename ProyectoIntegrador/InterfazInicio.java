...
public class InterfazInicio extends JFrame {
	...
	public InterfazInicio() {
		...
		// WINDOW LISTENER PARA QUE CAMBIE SU NOMBRE
		...
		mntmMonedero = new JMenuItem("Monedero: " + monedero + "");
		...
		mnApuestas.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				InterfazApuestas apuesta = null;

				try {

					apuesta = new InterfazApuestas(usuario, monedero);
