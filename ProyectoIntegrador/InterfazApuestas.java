...
public class InterfazApuestas extends JFrame {
	...
	public InterfazApuestas(String usuario, double monedero) throws Exception {
		...
		// LA TABLA APUESTAS NOS MUESTRA LOS PARTIDOS SELECCIONADOS A LOS QUE SE DESEA APOSTAR
		
		tablaApuestas = new JTable();

		// PARTIDOS CONSTRUIDOS POR DEFECTO
		
		partidos = new DefaultTableModel(new Object[][] { { "Nadal vs Djokovic", "x1,24" },
		...
		// AL AÑADIR PARTIDOS DE TABLA PARTIDOS SU INFORMACIÓN SE COPIA A LA TABLA APUESTAS
		...
		// LOS BOTONES DE AÑADIR DINERO Y APOSTAR QUE SE ENCUENTRAN MÁS ABAJO SOLO FUNCIONAN SI SE HA INICIADO SESIÓN PREVIAMENTE
	...
	// LOS BOTONES SE ENCIENDEN O APAGAN EN FUNCIÓN DE LA COLUMNA SELECCIONADA Y DE SÍ HAY DATOS EN LA TABLA
	...
	// SOLO SE PODRÁ AÑADIR DINERO DE FORMA NUMÉRICA Y AL ERRAR EL INGRESO RESETEA EL VALOR DE LA CAJA DE TEXTO
